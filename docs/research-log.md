...
the findings live. Detailed specs go in `data/`; forks go in `decisions/`.
...
|------|--------|--------|------------------|
| 2026-07-08 | DC split/mini-split AC units (12/24/48 V) | ✅ done | `data/parts/ac-units.json` — Full Battery 24V 9k (~$2,030, ~500 W/19 A, no converter) is the standout affordable 24 V; 12 V coolers $335–895; HotSpot/Full Battery 48 V. |
| 2026-07-08 | No-weld LFP battery cells (Battery Hookup) | ✅ done | `data/parts/batteries.json` — EVE LF206/LF280K bolt-terminal cells (~$70–77/kWh) scale to 4S/8S/16S; 48 V turnkey rack module ~$384. Flat-terminal weld-only cells excluded. |
| 2026-07-08 | Surplus panels, SF Bay Area | ✅ done (FB login-walled) | `data/parts/solar-panels.json` — Craigslist used 300–315 W at ~$0.15/W; Renogy 400 W foldable ~$195. FB Marketplace not accessible — self-search tips captured. |
| 2026-07-08 | AC-inverter mini-splits (115/230 V) | ✅ done | `data/parts/ac-units.json` — 115 V preferred; pick on **EER not SEER2**; Midea U 8k window $350 (no lineset), C&H 6k smallest split, MRCOOL DIY (no vacuum), Pioneer Quantum Ultra (13 EER2). |
| 2026-07-08 | DC-DC converters 24→12 / 48→12 | ✅ done | `data/parts/dc-dc-converters.json` — 24→12 @60–80 A easy/cheap ($70–290); 48→12 thinner/pricier; ~5–15% loss + a failure point. Native-voltage AC unit often deletes the converter at $0 extra. |
| 2026-07-08 | Inverters for AC mini-split (12/24/48 V) | ✅ done | `data/parts/inverters.json` — best 2–3 kW units are 24/48 V; idle draw matters (Victron ~8–13 W frugal, all-in-ones ~40–70 W); standalone vs all-in-one tradeoff. |
...
`data/parts/*.json` is now the single source of truth for parts (the markdown
