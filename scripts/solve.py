...
def report_one(cfg, combo, m, checks, costs):
    ...
    order = ["thermal_load_w", "ac_cooling_w", "ac_duty_cycle", "ac_avg_power_w",
             ...
             "panel_series", "panel_strings", "panels_needed", "array_w_provided", "battery_charge_v",
             "panel_string_voc_cold", "panel_string_vmp_hot", "pv_string_current_a",
             "mppt_current_required", "controllers_needed", "panel_voc_cold",
